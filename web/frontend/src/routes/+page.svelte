<div class="flex flex-col min-h-screen bg-gray-50">
	...
	<header class="bg-white shadow-md">
		<nav class="container mx-auto px-6 py-4 flex justify-between items-center">
			<a href="/" class="text-3xl font-bold text-blue-600"> RAGaik </a>
	...
	<main class="flex-grow">
		...
		<section id="features" class="bg-gray-50">
			<div class="container mx-auto px-6 py-16">
				<h2 class="text-3xl font-bold text-gray-800 text-center">Преимущества нашего проекта</h2>
				<div class="mt-12 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
					...
					<div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-start">
						<div class="flex items-center">
							<svg
								class="h-12 w-12 text-blue-600 mb-4 mr-2"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
								transform="scale(-1, 1)"
						...
						<p class="text-gray-600">
							Чат-бот использует информацию только из одобренных источников, поэтому точно не
							ошибется!<a href="#footnote-1" class="text-gray-400"><sup>1</sup></a>
						</p>
					</div>
					<!-- Карточка 2 -->
					<div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-start">
						...
						>
							<path
								d="M4 3h13a2 2 0 012 2v16l-4-2-4 2-4-2-4 2V5a2 2 0 012-2z"
								fill="currentColor"
							/>
							<path d="M6 6h9v2H6V6zm0 4h9v2H6v-2zm0 4h9v2H6v-2z" fill="#fff" />
							<path
								d="M17 3v9l-2.5-1.5L12 12V3h5z"
								fill="currentColor"
								stroke="#fff"
								stroke-width="1"
							/>
						</svg>
						<h3 class="text-xl font-semibold text-gray-800 mb-2">Поддержка русского языка</h3>
						<p class="text-gray-600">
							Теперь для изучения твоего любимого предмета не нужно покупать русско-китайский
							словарь! Достаточно спросить RAGaik
						</p>
					</div>
					<!-- Карточка 3 -->
					<div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-start">
						...
						>
							<path
								d="M64 4C31.4 4 4 31.4 4 64s27.4 60 60 60 60-27.4 60-60S96.6 4 64 4zm0 112c-28.7 0-52-23.3-52-52S35.3 12 64 12s52 23.3 52 52-23.3 52-52 52z"
							/>
							<text
								x="50%"
								y="50%"
						...
						<h3 class="text-xl font-semibold text-gray-800 mb-2">Поддержка LaTeX</h3>
						<p class="text-gray-600">
		...
		<section class="bg-blue-600">
			<div class="container mx-auto px-6 py-16 text-center text-white">
				<h2 class="text-3xl font-bold">Захотелось попробовать?</h2>
