	...
	let messages: Message[] = [
		{
			id: 1,
			user: 'bot',
			text: 'Привет, я твой цифровой ассистент, спрашивай все, что угодно!'
		}
	];
...
<!-- MAIN LAYOUT -->
<div
	class="flex flex-col h-[calc(100vh-80px)] max-h-[calc(100vh-80px)] bg-white overflow-hidden py-4"
>
	<!-- Chat area -->
	<div
	...
	>
		...
		{#if loading}
			<div class="flex justify-start">
				<div
					class="w-6 h-6 border-4 border-blue-400 border-t-transparent rounded-full animate-spin"
				></div>
			</div>
		{/if}
	</div>
